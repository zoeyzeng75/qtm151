...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/github-clone02.png}
\caption{Clone the Repository}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/github-clone03.png}
\caption{Cloning}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{images/github-open-vscode.png}
