...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Variables and Lists](https://danilofreire.github.io/qtm151/lectures/lecture-03/03-variables-lists.html)"
...
# Any questions about installing Anaconda and Jupyter? 🐍 {background-color="#2d4563"}
