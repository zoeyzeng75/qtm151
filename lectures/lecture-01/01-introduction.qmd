...
## {background-image="../images/neymar.jpg" background-size="100%"}

## {background-image="../images/carnaval.jpg" background-size="100%"}

## {background-image="../images/montblanc.jpg" background-size="100%"}

## {background-image="../images/buzz.webp" background-size="100%"}

## {background-image="../images/moonwatch.jpg" background-size="100%"}

## {background-image="../images/moonwatch-movement.jpg" background-size="100%"}

## {background-image="../images/sp.jpg" background-size="100%"}
...
::: {.column width=50%}
![](../images/sql.png){width=400px}
![](../images/postgresql.webp){width=400px}
:::
::::
...
6. Use Quarto and Jupyter Notebooks for reproducible research
...
- Follow the instructions [Installing Python Using Anaconda](https://github.com/danilofreire/qtm151/tutorials) from GitHub
...
- Follow the instructions [Installing Visual Studio Code and Connecting it with Anaconda](https://github.com/danilofreire/qtm151/tutorials) from GitHub
- For now: know that "base" is the Anaconda virtual environment that comes by default with the installation​
- The next step is to check if the connection between VS code and Anaconda worked -> [the Python: Select Interpreter option should include Python ("base")​]{.alert}
- Next step: we will create a new folder for the QTM151 course and download our virtual GitHub folder and opening it in VS Code

## {background-image="../images/github01.png" background-size="100%"}

## {background-image="../images/github02.png" background-size="100%"}
...
::: {.column width=30%}
::: {style="font-size: 26px;"}
- We will use Jupyter Notebooks for our classes
...
- Lecture notes are designed to be follow-along. There will be "try it yourself" exercises throughout the lecture
:::
:::
...
- We will start with the basics of Python, Jupyter Notebooks, and Quarto
- We will also cover the basics of Anaconda and VS Code
- Please remember to check the course website: <https://danilofreire.github.io/qtm151>
