...
This tutorial will introduce you to [Jupyter Notebook](https://jupyter.org/documentation) and [Markdown](https://www.markdownguide.org/). Jupyter Notebook is a web-based interactive computing platform that allows users to create and share documents that contain live code, equations, visualisations, and narrative text. Markdown is a lightweight markup language that is used to format text, and can be used for everything - websites, documents, notes, books, presentations, email messages, and technical documentation. Even WhatsApp and Facebook Messenger use Markdown to format messages. So if you have already italicised a word or made a text bold on WhatsApp, you have used Markdown! 
...
First, please make sure you have Python, Jupyter Notebook, and VSCode installed on your computer. If you do not have these installed, please refer to the [VSCode and Anaconda Tutorial](https://github.com/danilofreire/qtm151/blob/main/tutorials/01-vscode-anaconda-tutorial.pdf) for instructions on how to install them.
...
To create a text cell click on "+ Text." You will get an empty white box where you can type text. You can format the text using Markdown. We will cover Markdown in more detail in the next section. But for now, you can type the following text in the text cell:

```{markdown}
# Welcome to QTM 151!

This is a Jupyter Notebook. You can write *text*, **equations**, and `code` 
in [this notebook](https://github.com/danilofreire/qtm151/tutorials). 
```
...
You can use Markdown to create headings, lists, tables, equations, and figures. Here are some examples of how to format your text using Markdown:
...
When working with pandas DataFrames, you can convert them into Markdown tables for better presentation. Here is how to do it:
...
You can install tabulate using conda:
...
To display the Markdown table in a Jupyter Notebook cell, use the `display()` function:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/markdown-table.png}
...
The `tabulate` library offers more formatting options:
...
1. **Index**: Consider whether you need the index in your table. Often, i's cleaner to exclude it using `index=False`.
