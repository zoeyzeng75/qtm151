...
## VS Code for the Web and GitHub Codespaces

Microsoft has just released **VS Code for the Web**, a web-based version of the editor that runs in the browser. You can access it at <https://vscode.dev/>. However, the web version does not have all the features of the desktop version, such as access to a terminal to run Python code. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/vscode-web.png}
    \caption{VS Code for the Web}
...
Now that both VS Code and Anaconda are installed, we will connect them to use Anaconda's Python distribution within VS Code.
...
# Additional VS Code Settings for Python Development

These suggested settings will help you work more efficiently with Python in VS Code.
