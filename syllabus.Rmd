...
Throughout the semester, we will cover version control for collaborative coding, Jupyter Notebooks for reproducible research, Python programming fundamentals, data wrangling and merging in SQL, data visualisation, and introductions to linear modelling and time series analysis.

By working with real-world datasets and problems, students will gain hands-on experience using these tools and methods to extract meaningful insights from data. The course develops technical skills and critical thinking needed to solve complex data challenges. Upon completion, students will be prepared for advanced coursework in quantitative methods and data science.
...
Students have to submit a series of problem sets and complete one group project. You are allowed to use AI to assist with your assignments, as learning to use AI is a valuable and emerging skill. I recommend using [GitHub Copilot](https://copilot.github.com/) to generate code snippets, as it is free for students and provides good suggestions and explanations. [Claude](https://claude.ai), [ChatGPT](https://chat.openai.com), and [Perplexity AI](https://perplexity.ai) are also good tools. I am available to provide support and assistance with these tools during office hours or by appointment. However, please note that any errors or omissions resulting from the use of AI tools are your responsibility. Do not rely solely on AI to complete your assignments; you must always double-check your work. Remember to cite all sources used in your problem sets and projects, including AI tools. Please include a note at the end of any document indicating that AI was used in its development.
...
- Lecture 02: [GitHub Review](https://danilofreire.github.io/qtm151/lectures/lecture-02/02-github-review.html) and [Introduction to Jupyter Notebooks](https://danilofreire.github.io/qtm151/lectures/lecture-02/02-jupyter.ipynb).
...
- Lecture 03: [Mathematical Operations, Arrays, and Random Numbers](https://danilofreire.github.io/qtm151/lectures/lecture-03/03-maths-arrays-random.ipynb).
...
- Lecture 05: [While Loops and For Loops](https://danilofreire.github.io/qtm151/lectures/lecture-05/05-while-for.ipynb).

*Wednesday, September 18:*

- Lecture 06: [Applications 1: Simulation Studies](https://danilofreire.github.io/qtm151/lectures/lecture-06/06-simulation-studies.ipynb).
...
- Lecture 07: [Functions and Arguments](https://danilofreire.github.io/qtm151/lectures/lecture-07/07-functions-arguments.ipynb).

*Wednesday, September 25:*

- Lecture 08: [Global and Local Variables](https://danilofreire.github.io/qtm151/lectures/lecture-08/08-global-local.ipynb).
...
- Lecture 09: [**Quiz 01: Application 02 - Operations over Multiple Datasets (6%)**](https://danilofreire.github.io/qtm151/lectures/lecture-09/09-application-operations.ipynb).

*Wednesday, October 02:*

- Lecture 10: [Subsetting Data](https://danilofreire.github.io/qtm151/lectures/lecture-10/10-subsetting-data.ipynb).
...
- Lecture 11: [Application 03: Linear Models](https://danilofreire.github.io/qtm151/lectures/lecture-11/11-application-linear-models.ipynb). 
...
- Lecture 12: [Creating and Replacing Variables](https://danilofreire.github.io/qtm151/lectures/lecture-12/12-creating-replacing.ipynb).
...
- Lecture 13: [**Quiz 2: Application 4: Random Assignment (6%)**](https://danilofreire.github.io/qtm151/lectures/lecture-13/13-application-random-assignment.ipynb).
...
- Lecture 14: [Aggregating Data](https://danilofreire.github.io/qtm151/lectures/lecture-14/14-aggregating-data.ipynb).

*Wednesday, October 23:*

- Lecture 15: [Merging Data](https://danilofreire.github.io/qtm151/lectures/lecture-15/15-merging-data.ipynb).
...
- Lecture 16: [Introduction to SQL](https://danilofreire.github.io/qtm151/lectures/lecture-16/16-introduction-sql.ipynb).

*Wednesday, October 30:*

- Lecture 17: [**Quiz 3: Application 5: SQL Queries (6%)**](https://danilofreire.github.io/qtm151/lectures/lecture-17/17-application-sql-queries.ipynb).
...
- Lecture 18: [Merging Tables in SQL](https://danilofreire.github.io/qtm151/lectures/lecture-18/18-merging-tables.ipynb).

*Wednesday, November 06:*

- Lecture 19: [Import SQL Data into Python](https://danilofreire.github.io/qtm151/lectures/lecture-19/19-import-sql-data.ipynb).
...
- Lecture 20: [Time Series Analysis](https://danilofreire.github.io/qtm151/lectures/lecture-20/20-time-series.ipynb).

*Wednesday, November 13:*

- Lecture 21: [**Quiz 4: Application 6: Practice SQL Queries (6%)**](https://danilofreire.github.io/qtm151/lectures/lecture-21/21-application-sql-queries.ipynb).
...
- Lecture 22: [Pivot Tables](https://danilofreire.github.io/qtm151/lectures/22-pivot-tables/22-pivot-tables.ipynb).

*Wednesday, November 20:*

- Lecture 23: [**Quiz 5: Application 8: Time Data, Panel Data, and Plots (6%)**](https://danilofreire.github.io/qtm151/lectures/23-application-time-panel-plots.ipynb).
...
- Lecture 24: [Manipulating Text Data](https://danilofreire.github.io/qtm151/lectures/24-text-data/24-text-data.ipynb).

*Wednesday, November 27: Thanksgiving Break (no class)*

*Monday, December 02:*

- Lecture 25: [Advanced Plots I](https://danilofreire.github.io/qtm151/lectures/25-advanced-plots/25-advanced-plots.ipynb).

*Wednesday, December 04:*

- Lecture 26: [Advanced Plots II](https://danilofreire.github.io/qtm151/lectures/26-advanced-plots/26-advanced-plots.ipynb).
