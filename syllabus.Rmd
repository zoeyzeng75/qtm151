...
Welcome to [QTM 151](https://github.com/danilofreire/qtm151)! This is an introductory course designed to equip students with essential skills in data analysis and statistical computing using Python and SQL. It is tailored for students with little to no prior programming experience who are eager to develop computational proficiency for data-driven decision making. 
...
By working with real-world datasets and problems, students will gain hands-on experience using these tools and methods to extract insights from data. This course will develop technical skills and critical thinking needed to solve complex data challenges. Upon completion, students will be prepared for advanced coursework in quantitative methods and data science.
...
Students have to submit ten assignments and complete one group project for this course. You are allowed to use AI to assist with your assignments, as learning to use AI is a valuable and emerging skill. I recommend using [GitHub Copilot](https://copilot.github.com/) to generate code snippets, as it is free for students and provides good suggestions and explanations. [Claude](https://claude.ai), [ChatGPT](https://chat.openai.com), and [Perplexity AI](https://perplexity.ai) are also good tools. I am available to provide support and assistance with these tools during office hours or by appointment. However, please note that any errors or omissions resulting from the use of AI tools are your responsibility. Do not rely solely on AI to complete your assignments; you must always double-check your work. Remember to cite all sources used in your problem sets and projects, including AI tools. Please include a note at the end of any document indicating that AI was used in its development.
...
**Mid-Semester and End-of-Semester Evaluations (0.5% each, bonus).** Students will be asked to complete a mid-semester and end-of-semester evaluation of the course. These evaluations are anonymous and will be used to improve the course in future semesters. Students who complete both evaluations will receive a 1% bonus on their final grade.
...
**Week 04: Boolean Variables and Loops**
...
**Week 05: Applications and Functions**
...
**Week 06: Global and Local Variables, Quiz 01**
...
- Lecture 18: [**Quiz 3: Application 5: SQL Queries (6%)**](https://github.com/danilofreire/qtm151/blob/main/lectures/lecture-18/18-sql-queries.ipynb).

*Wednesday, November 06:*

- Lecture 19: [Merging Tables in SQL](https://github.com/danilofreire/qtm151/blob/main/lectures/lecture-19/19-merging-tables.ipynb).


[Import SQL Data into Python](https://danilofreire.github.io/qtm151/lectures/lecture-19/19-import-sql-data.ipynb).
