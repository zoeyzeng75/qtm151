...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Maths with NumPy](https://rawcdn.githack.com/danilofreire/qtm151/c972c0e31ff8b65cdc8b59f510d2831eaf13ef41/lectures/lecture-04/04-maths-arrays-random.html)"
transition: slide
...
- Create histograms and scatter plots using `matplotlib`
:::
...
- Compute $\frac{1}{\sqrt{2\pi}}e^{-x^2}$
  - This is the probability density function of the standard normal distribution (don't worry if you don't know what it is yet! 🤓) [[Appendix 01]{.button}](#sec-appendix-01)
